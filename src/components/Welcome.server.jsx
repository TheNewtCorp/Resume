...
import modernreptile from '../modernreptile.webp';
import isopodauction from '../isopodauctionlogo.png';
import twotenreptiles from '../210reptiles.png';
import tlux from '../tlux.png';
import '../index.css';
  ...
  return (
    <div className="text-gray-900 pt-16 rounded-[40px] my-16 px-4 xl:px-12 bg-gradient-to-b from-white -mx-4 xl:-mx-12">
      <div className="text-center mb-16">
        <h1 className="font-extrabold capitalize mb-4 text-base md:text-4xl">
          NEWTON CORDEIRO
        </h1>
        <p className="font-bold text-lg mb-8">React Web Developer</p>
        <p className="text-lg mb-8">
          Please feel free to look over my portfolio. These are some businesses
          that I was fortunate to work with in order to create a website for
          their E-Commerce and Marketing brands.
        </p>
        <p className="text-lg mb-8">
          Please note that although this web app was created using Hydrogen
          React, the websites below were made in shopify using liquid syntax,
          along with standard Javascript, CSS and HTML.
        </p>
      </div>
      <div className="flex justify-between grid-cols-1 lg:grid-cols-2 gap-1 lg:gap-1">
        <a href="https://modernreptileshop.com/">
          <Image
            className="hoversizeincrease"
            src={modernreptile}
            height={'80%'}
            width={'80%'}
          />
        ...
        <a style={{marginTop: '20px'}} href="https://isopodauction.com/">
          <Image
            className="hoversizeincrease"
            src={isopodauction}
            height={'80%'}
        ...
        <a
          style={{marginRight: '-80px', marginBottom: '90px'}}
          href="https://tluxevents.com/"
        >
          <Image
            className="hoversizeincrease"
            src={tlux}
